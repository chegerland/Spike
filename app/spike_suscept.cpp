...
void main_process(SusceptibilitySimulation &suscept_sim,
                  const std::string &output_file);
void sub_process(SusceptibilitySimulation &suscept_sim);
...
int main(int argc, char *argv[]) {
  ...
  SusceptibilitySimulation suscept_sim(input_file);
